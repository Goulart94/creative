            ...
            <div className={style.team}>
              <div className={style.cardTeamMaycon}>
                ...
                <div className={style.containerTextTeam}>
                  ...
                  <p>
                    “O que fazemos é ajudar as pessoas, seja através do desenvolvimento de projetos ou com até mesmo um sorriso. Não somos uma empresa de tecnologia apenas, somos uma empresa que usa da tecnologia para o bem de pessoas.    ”
                  </p>
                  <h4>CEO / Developer</h4>
                </div>
              </div>
