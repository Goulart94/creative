        ...
        <section className={style.sectionFour}>
          ...
          <div className={style.containerTeam}>
            <div className={style.team}>
              <div className={style.cardTeamMaycon}>ff</div>
              <div className={style.cardTeamTalita}>dd</div>
              <div className={style.cardTeamRafael}>gg</div>
              <div className={style.cardTeamTais}>hh</div>
            </div>
          </div>
        </section>
      </ScrollAnimation>
