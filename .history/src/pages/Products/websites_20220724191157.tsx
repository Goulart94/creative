    ...
    <div className={style.sectionThree}>
       ...
       <div className={style.containerTextThree}>
        ...
        <div className={style.mainThree}>
          <div><img src="/images/pc.png" alt="" /></div>
          <div>
            <p>  Uma loja online está sempre aberta e pronta para vender, dispensa
 funcionários para efetuar a venda com isso diminuindo o seu custo.
 O alcance da sua loja passa a ser muito maior e com isso consegue 
ganhar novos clientes.
  Hoje em dia não se trata mais de um luxo ter uma loja online para o 
seu negocio e sim uma necessidade, em pleno século XXI um negoc-
io para crescer e alcançar seus objetivos por padrão ele tem que está 
online.
 Uma loja online se traduz basicamente como baixo custo e chances
 de grandes ganhos, não deixe sua ideia ou produto guardado em sua
