...
import {RiFocus3Line, RiRunLine, RiRocketFill, RiChat1Fill, RiCoinsLine, RiMentalHealthLine} from 'react-icons/ri';
        ...
        <SwiperSlide className={style.caroselGrid}>
            ...
            <div className={style.card}>
             ...
             <div className={style.ContentTitle}>
              ...
              <p>Na área da tecnologia tudo muda constantemente e temos com dever nos manter atualizados. <br></br> Para sempre conseguirmos entregar Websites modernos e eficientes para nossos clientes.    </p>
             </div>
            </div>
        </SwiperSlide>
        <SwiperSlide  className={style.caroselGrid}>
