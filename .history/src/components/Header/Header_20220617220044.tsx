  ...
  return (
    <header className={style.headerContainer}>
      ...
      <div className={style.containerNav}>
        ...
        <Link href='./'><a className={asPath === '/' ? `${style.active}` : ''} onClick={()=>setNav(false)}>Produtos</a></Link>
        <Link href='./'><a className={asPath === '/' ? `${style.active}` : ''} onClick={()=>setNav(false)}>Contatos</a></Link>
        </nav>
