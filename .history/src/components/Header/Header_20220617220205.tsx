  ...
  return (
    <header className={style.headerContainer}>
      ...
      <div className={style.containerNav}>
        ...
        <Link href='./Products'><a className={asPath === '/' ? `${style.active}` : ''} onClick={()=>setNav(false)}>Produtos</a></Link>
        <Link href='./Contacts'><a className={asPath === '/' ? `${style.active}` : ''} onClick={()=>setNav(false)}>Contatos</a></Link>
        </nav>
