...
export default function ManuntecaoWebsites() {
  return (
    <>
    {/* 
    ---------------------------------------------------------------------------------------------------------------
    ...
    */}
    <div className={style.sectionFour}>
      <div className={style.titleFour}>
        <h2>O que está incluído no seu Website</h2>
      </div>

      <div className={style.textFour}>
        <p>
          Todos os websites que desenvolvemos na nossa agência, têm incluídas
          um conjunto de funcionalidades essenciais, que permitem que qualquer
          cliente da Creative comece a trabalhar desde o primeiro dia.
          <br></br>
          <h3>Módulo WebSite</h3>
          <ul>
            <li>Produtos e Categorias ilimitadas</li>
            <li>Dashboard de vendas online</li>
            <li>Pagamentos Online via Cartão de Credito e/ou Paypal</li>
            <li>Barra de Pesquisa de artigos</li>
            <li>Artigos/Preço de Promoção</li>
            <li>Variações de Produto (Cor, Tamanho, etc..)</li>
            <li>Refund de artigos</li>
            <li>Reviews de produtos</li>
            <li>Cross-selling de Artigos Similares</li>
            <li>Página de Artigos em Destaques</li>
            <li>Importação/Edição de artigos através do EXCEL</li>
            <li>Catálogo de produtos com categorias e subcategorias</li>
            <li>
              Ordenar artigos (alfabeticamente, popularidade, preço, etc..)
            </li>
            <li>Gestão de Stock</li>
            <li>Cupões de desconto</li>
            <li>Opções de forma de envio (no local ou por correio)</li>
            <li>Cálculo de portes de envio simples</li>
            <li>
              Zona de cliente (encomendas recentes, gestão de morada, etc)
            </li>
            <li>
              E Mails de notificação automáticos (encomenda feita, encomenda
              enviada etc..)
            </li>
          </ul>
        </p>
